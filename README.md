...
It is built using **FastAPI**, connects to **AWS DynamoDB**, and integrates a **machine learning model** to provide demand forecasting and reorder recommendations. Here is the link to the [frontend](https://github.com/JayashreeJanani/inventory-frontend)
